 ...
 * @group UC-AddEntry
 */
final class AC02_MissingTitleCest extends BaseAddEntryFunctionalCest
{
    /**
     ...
     * @return void
     */
    public function testMissingTitleIsRejectedWithTitleRequired(FunctionalTester $I): void
    {
        // Arrange
        $dataset = AddEntryDataset::ac02MissingTitle();
